...
public class Task {
    ...
    public Task(UUID id, String title, String description, LocalDateTime dueDate, TaskPriority priority, TaskStatus status, LocalDateTime createdDate, LocalDateTime updatedDate, TaskList taskList) {
        this.id = id;
        this.title = title;
